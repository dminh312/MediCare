  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Change Password',
          style: TextStyle(color: isDarkMode ? Colors.white : Colors.black, fontSize: 18, fontWeight: FontWeight.bold, fontFamily: 'Plus Jakarta Sans'),
        ),
        centerTitle: true,
      ),
      body: Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(fontSize: 12, color: isDarkMode ? Colors.grey[500] : Colors.grey[600], height: 1.5, fontFamily: 'Plus Jakarta Sans'),
      ...
      children: [
        ...
        if (helperText != null)
          Padding(
            ...
            child: Text(helperText, style: TextStyle(fontSize: 11, color: isDarkMode ? Colors.grey[500] : Colors.grey[400], fontFamily: 'Plus Jakarta Sans')),
          ),
      ],
    );
  }
