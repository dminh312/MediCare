                ...
                children: [
                  _buildSettingsSection(
                    ...
                    items: [
                      ...
                      _buildSettingsItem(context, Icons.notifications, const Color(0xFFfff3e0), const Color(0xFFFF9800), 'Notification Settings', isDarkMode),
                      _buildSettingsItem(context, Icons.security, const Color(0xFFe3f2fd), const Color(0xFF2196F3), 'Security & Privacy', isDarkMode),
                    ],
                  ),
                  ...
                  _buildSettingsSection(
                    ...
                    primaryColor: primaryColor,
                    items: [
                      _buildSettingsItem(context, Icons.help_center, const Color(0xFFf3e5f5), const Color(0xFF9c27b0), 'Help & Support', isDarkMode),
                    ],
                  ),
