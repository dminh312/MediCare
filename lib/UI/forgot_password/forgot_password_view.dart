                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                          ...
                          borderSide: const BorderSide(color: Color(0xFFe5dcdd), width: 1),
                        ),
                ...
                children: [
                  ...
                  TextButton.icon(
                    ...
                    icon: const Column(
                      ...
                      children: [
                        Text('I can\'t remember', style: TextStyle(color: primaryColor, fontWeight: FontWeight.w600, fontSize: 14, height: 1.1)),
                        Text('my email', style: TextStyle(color: primaryColor, fontWeight: FontWeight.w600, fontSize: 14, height: 1.1)),
                      ],
                    ),
